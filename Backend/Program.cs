...
builder.Services.AddDbContext<DeportivoContext>(
    options => options.UseMySql(cadenaConexion,
                                ServerVersion.AutoDetect(cadenaConexion)));

// Learn more about configuring Swagger/OpenAPI at https://aka.ms/aspnetcore/swashbuckle

// Configura el serializador JSON para manejar referencias cíclicas. Cuando entrega un objeto que tiene referencias circulares, las ignora para evitar errores de serialización. 
builder.Services.AddControllers()
...
// Configurar una política de CORS --WEB--
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowSpecificOrigins",
        builder => builder
            .WithOrigins("https://deportivo.azurewebsites.net/",
                    "https://www.deportivo.azurewebsites.net/",
